...
router.get("/edit", function (req, res) {
   ...
   connection.query(sql, function (err, result) {
      ...
      res.render("./admin/concert-index/concert-showtime/edit", {
         showtime: "",
         search: result
      });
   });
...
router.post("/edit", isAdmin, function (req, res) {
   var allShowtimeData = [];
   var search = req.body.search;
   var sqlSearch = "SELECT * FROM concert_showtime cs, concert c WHERE cs.Concert_ID = c.Concert_ID AND c.Concert_Name = ?;";
