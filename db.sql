...
--
-- Host: 127.0.0.1
-- Generation Time: May 24, 2019 at 07:08 PM
...
INSERT INTO `concert_showtime` (`Concert_ShowTime_ID`, `Concert_ShowTime`, `Concert_ShowTime_Plan`, `Concert_ID`) VALUES
...
--
ALTER TABLE `concert_showtime`
  MODIFY `Concert_ShowTime_ID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `zone`
  ADD CONSTRAINT `zone_ibfk_1` FOREIGN KEY (`Concert_ShowTime_ID`) REFERENCES `concert_showtime` (`Concert_ShowTime_ID`);
COMMIT;
